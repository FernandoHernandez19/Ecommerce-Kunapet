  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 w-full lg:w-72 flex-shrink-0">
      <div className="flex justify-between items-center mb-6 border-b border-gray-100 pb-4">
        ...
        <button className="text-xs font-bold text-[#006D44] hover:text-[#005233] transition-colors">
          Limpiar
        </button>
      </div>
      ...
      <div className="space-y-8">
          ...
          <div className="space-y-3">
            <label className="flex items-center justify-between cursor-pointer group">
              <div className="flex items-center space-x-3">
                <input type="checkbox" defaultChecked className="w-4 h-4 text-[#006D44] rounded focus:ring-[#006D44] border-gray-300" />
        ...
        <div>
          ...
          <div className="flex flex-wrap gap-2">
            <button className="bg-emerald-400 text-white text-xs font-bold px-3 py-1.5 rounded-full hover:bg-emerald-500 transition-colors">Servicio</button>
