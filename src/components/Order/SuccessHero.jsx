  ...
  return (
    <div className="flex flex-col items-center text-center mb-12 animate-fade-in-down">
      <div className="w-20 h-20 bg-emerald-100 rounded-full flex items-center justify-center mb-6 shadow-sm">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={3} stroke="currentColor" className="w-10 h-10 text-[#006D44]">
      ...
      <div className="flex items-center space-x-4">
        ...
        <button className="flex items-center text-[#006D44] hover:text-[#005233] text-sm font-bold transition-colors ml-2" title="Descargar Recibo">
