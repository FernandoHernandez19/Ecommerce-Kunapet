  ...
  return (
    <div className="flex flex-col items-center text-center mb-10">
      ...
      <div className={`w-24 h-24 bg-emerald-200 rounded-full flex items-center justify-center mb-6 shadow-sm transition-all duration-700 transform ${animate ? 'scale-100 opacity-100' : 'scale-50 opacity-0'}`}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-12 h-12 text-[#006D44]">
      ...
      <h1 className="text-3xl sm:text-4xl font-extrabold text-[#006D44] tracking-tight mb-4">
        ¡Mascota Registrada!
      </h1>
