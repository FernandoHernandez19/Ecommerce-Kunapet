...
export default function FinalStepper() {
  return (
    <div className="mt-12 flex items-center justify-center space-x-2 animate-fade-in">
      {/* Guiones completados */}
      <div className="w-8 h-2 bg-[#e23d28] rounded-full"></div>
      <div className="w-8 h-2 bg-[#e23d28] rounded-full"></div>
      <div className="w-8 h-2 bg-[#e23d28] rounded-full"></div>
      
      {/* Último guion con la huella */}
      <div className="w-8 h-2 bg-[#e23d28] rounded-full relative">
        <span className="absolute -top-5 -right-1 text-[#e23d28] text-xs">
