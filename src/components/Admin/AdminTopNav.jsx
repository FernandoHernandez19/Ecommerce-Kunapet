    ...
    <header className="h-20 bg-white/80 backdrop-blur-md flex items-center justify-between px-8 sticky top-0 z-10 border-b border-gray-100">
      <div className="flex-1 max-w-xl">
        <div className="relative group">
          <span className="absolute inset-y-0 left-0 flex items-center pl-4 text-gray-400 group-focus-within:text-emerald-600 transition-colors">
            🔍
          </span>
          <input 
            type="text" 
            placeholder="Buscar usuarios, proveedores o reportes..." 
            className="w-full bg-gray-50/50 hover:bg-gray-50 border border-gray-200 text-sm rounded-xl pl-10 pr-4 py-2.5 outline-none focus:ring-2 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all"
          />
        </div>
      </div>
      <div className="flex items-center space-x-5 ml-4">
        ...
        <button className="text-gray-500 hover:text-emerald-700 transition-colors text-xl">
          ⊞
        </button>
