    ...
    <div className="mb-6 relative z-10">
      ...
      <div 
        ...
        className={`border-2 border-dashed rounded-2xl p-8 flex flex-col items-center justify-center cursor-pointer transition-colors ${
          isDragging ? 'border-[#e23d28] bg-red-50/50' : 'border-gray-300 bg-gray-50/50 hover:bg-gray-50'
        }`}
      >
        ...
        <p className="text-sm font-bold text-gray-800">Haz clic o <span className="text-[#e23d28]">arrastra</span> una imagen aquí</p>
