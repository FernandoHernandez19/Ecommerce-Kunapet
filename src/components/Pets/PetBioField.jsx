  ...
  return (
    <div className="bg-white rounded-2xl p-6 md:p-8 border border-gray-100 shadow-sm">
      <h3 className="text-lg font-bold text-gray-900 flex items-center mb-2">
        <span className="text-[#006D44] mr-2">📝</span> Breve Biografía
      </h3>
      ...
      <div className="relative">
        <textarea
          ...
          className="w-full bg-[#F9FAFB] border border-gray-100 rounded-xl p-4 min-h-[160px] text-sm text-gray-700 focus:outline-none focus:ring-2 focus:ring-[#006D44]/20 focus:border-[#006D44] resize-none transition-all pb-8"
        />
