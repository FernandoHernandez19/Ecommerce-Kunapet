  ...
  return (
    <div className="min-h-screen bg-[#FDFDFD] font-sans text-gray-800 flex flex-col">
      ...
      <header className="h-20 bg-white border-b border-gray-100 flex items-center justify-between px-6 lg:px-12 sticky top-0 z-30">
        <a href="/cart" className="flex items-center text-sm font-semibold text-gray-500 hover:text-emerald-700 transition-colors">
          <span className="mr-2">←</span> Volver al carrito
        </a>
        <div className="absolute left-1/2 transform -translate-x-1/2">
          <span className="text-2xl font-black text-[#006D44] tracking-tight">KunaPet</span>
        </div>
      ...
      <footer className="bg-white py-10 px-6 lg:px-12 border-t border-gray-200 mt-auto">
        <div className="max-w-6xl mx-auto">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-8">
            <span className="text-xl font-black text-[#006D44]">KunaPet</span>
