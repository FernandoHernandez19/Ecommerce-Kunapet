  ...
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-6 shadow-sm mb-6">
      <h2 className="text-lg font-bold text-gray-900 flex items-center mb-2">
        <span className="text-[#006D44] mr-2">🐰</span> ¿Para quién es este pedido?
      </h2>
      ...
      <div className="flex flex-wrap gap-3">
        {pets.map((pet) => (
          <button
            ...
            className={`flex items-center space-x-2 px-4 py-2 rounded-full border text-sm font-bold transition-colors outline-none focus:ring-2 focus:ring-[#006D44] focus:ring-offset-1 ${
              selectedPet === pet.id 
        ...
        <button className="flex items-center space-x-2 px-4 py-2 rounded-full border border-dashed border-gray-300 text-sm font-bold text-[#006D44] hover:bg-gray-50 hover:border-[#006D44] transition-colors">
