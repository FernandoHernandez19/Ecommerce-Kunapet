...
export default function CategoryCards() {
  const categories = [
    { id: 1, title: 'Pedidos', desc: 'Envíos, devoluciones y seguimiento de productos.', icon: '🛍️', bg: 'bg-red-100', text: 'text-brand-primary' },
    { id: 2, title: 'Servicios', desc: 'Paseos, veterinaria y estética canina.', icon: '📅', bg: 'bg-red-100', text: 'text-brand-primary' },
  ...
  return (
    <div className="mb-16">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {categories.map((cat) => (
          <button key={cat.id} className="bg-white border border-gray-100 rounded-2xl p-6 flex flex-col items-center text-center shadow-sm hover:shadow-md hover:border-emerald-200 hover:-translate-y-1 transition-all group outline-none focus:ring-2 focus:ring-brand-primary">
