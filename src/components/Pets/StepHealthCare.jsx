  ...
  return (
    <div className="animate-fade-in-right">
      <div className="text-center mb-8">
        <h2 className="text-3xl font-extrabold text-[#006D44]">Salud y Cuidados</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
          <h3 className="text-base font-bold text-gray-900 flex items-center mb-5">
            <span className="text-[#006D44] mr-2">⚖️</span> Datos Físicos
          </h3>
          <div className="flex gap-4 items-end">
            <div className="flex-1">
              ...
              <input 
                ...
                placeholder="Ej: 12.5" 
                className="w-full bg-white border border-gray-200 p-2.5 rounded-xl text-sm outline-none focus:border-[#006D44]" 
              />
            </div>
            <div>
              ...
              <div className="flex items-center space-x-2 h-10">
                ...
                <button 
                  ...
                  className={`w-11 h-6 rounded-full flex items-center transition-colors p-1 ${formData.isSterilized ? 'bg-[#006D44]' : 'bg-gray-300'}`}
                >
        ...
        <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
          <h3 className="text-base font-bold text-gray-900 flex items-center mb-2">
            <span className="text-[#006D44] mr-2">💉</span> Vacunas Básicas
          </h3>
          ...
          <div className="space-y-3">
            {['Antirrábica', 'Múltiple / Polivalente', 'Tos de las perreras (Bordetella)'].map(vax => {
              ...
              return (
                <label key={vax} className={`flex items-center p-3 border rounded-xl cursor-pointer transition-colors ${isChecked ? 'border-[#006D44] bg-emerald-50/30' : 'border-gray-200 hover:border-emerald-300'}`}>
                  <input 
                    type="checkbox" 
                    checked={isChecked}
                    onChange={(e) => {
                    ...
                    className="w-4 h-4 text-[#006D44] rounded border-gray-300 focus:ring-[#006D44] mr-3"
                  />
        ...
        <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm md:col-span-2">
          <h3 className="text-base font-bold text-gray-900 flex items-center mb-4">
            <span className="text-[#006D44] mr-2">🤧</span> Alergias
          </h3>
          ...
          <textarea 
            ...
            className="w-full bg-gray-50 border border-gray-100 p-3 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#006D44]/20 resize-none mb-3"
          ></textarea>
          <div className="flex flex-wrap gap-2">
            <button onClick={() => handleAllergyChip('Sin alergias')} className="px-3 py-1 bg-emerald-100 text-emerald-800 text-xs font-bold rounded-full hover:bg-emerald-200">Sin alergias</button>
        ...
        <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm md:col-span-2">
          <h3 className="text-base font-bold text-gray-900 flex items-center mb-4">
            <span className="text-[#006D44] mr-2">♡</span> Necesidades Especiales
          </h3>
      ...
      <div className="flex justify-between items-center w-full mt-4">
        ...
        <button 
          onClick={onNext}
          className="bg-[#006D44] hover:bg-[#005233] text-white text-sm font-bold py-2.5 px-6 rounded-full shadow-md transition-colors flex items-center"
        >
